...
public class Super extends ActivatablePowerHero {
	...
	public void moveUpRight() throws UnallowedMovementException {
		throw new UnallowedMovementException("Super can not move in Upright direction",this, Direction.UPRIGHT);
	}

	@Override
	public void moveUpLeft() throws UnallowedMovementException {
		throw new UnallowedMovementException("Super can not move in Upleft direction",this, Direction.UPLEFT);
	}

	@Override
	public void moveDownRight() throws UnallowedMovementException {
		throw new UnallowedMovementException("Super can not move in Downright direction",this, Direction.DOWNRIGHT);
	}

	@Override
	public void moveDownLeft() throws UnallowedMovementException {
		throw new UnallowedMovementException("Super can not move in Downleft direction",this, Direction.DOWNLEFT);
	}
