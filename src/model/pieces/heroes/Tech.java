...
public class Tech extends ActivatablePowerHero {
	...
	public void moveUp() throws UnallowedMovementException {
		throw new UnallowedMovementException("Tech can not move in Up direction",this, Direction.UP);
	}

	@Override
	public void moveDown() throws UnallowedMovementException {
		throw new UnallowedMovementException("Tech can not move in Down direction",this, Direction.DOWN);
	}

	@Override
	public void moveRight() throws UnallowedMovementException {
		throw new UnallowedMovementException("Tech can not move in Right direction",this, Direction.RIGHT);
	}

	@Override
	public void moveLeft() throws UnallowedMovementException {
		throw new UnallowedMovementException("Tech can not move in Left direction",this, Direction.LEFT);
	}
